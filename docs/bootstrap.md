...
* **Next Major Milestone (今後のマイルストーン)**:
  * **Phase 2 (Long-term Memory Foundation / 長期記憶基盤)**:
    人間の認知制約に準拠した L0〜L4 階層型記憶システム（エピソードバッファ ＋ 意思決定/プロファイルの長期記憶）の構築。詳細および関連設計書は [Phase 2 統合マスター仕様書 (phase2-master-spec.md)](file:///Users/nabe/src/github.com/nabe126/kanon/docs/architecture/phase2-master-spec.md) を参照。
...
* **Memory Subsystem (Phase 2 構想)**: 人間の認知モデル（BaddeleyのWorking Memory + Tulvingの長期記憶）をベースにした L0〜L4 階層型記憶システム。詳細は [Phase 2 統合マスター仕様書 (phase2-master-spec.md)](file:///Users/nabe/src/github.com/nabe126/kanon/docs/architecture/phase2-master-spec.md) を参照。
* **Sandbox & コントローラーモデル**: 
...
4. [docs/architecture/phase2-master-spec.md](file:///Users/nabe/src/github.com/nabe126/kanon/docs/architecture/phase2-master-spec.md) - Phase 2 統合マスター仕様書。
